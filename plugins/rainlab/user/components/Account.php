...
class Account extends ComponentBase
{
    ...
    public function defineProperties()
    {
        return [
            ...
            'redirect_employer' => [
                'title'       => 'rainlab.user::lang.account.employer_redirect_to',
                'description' => 'rainlab.user::lang.account.employer_redirect_to_desc',
                'type'        => 'dropdown',
                'default'     => ''
            ],
            'paramCode' => [
    ...
    public function getRedirect_EmployerOptions()
    {
        return [''=>'- none -'] + Page::sortBy('baseFileName')->lists('baseFileName', 'baseFileName');
    }
    ...
    public function onSignin()
    {
        try {
            ...
            /*if ($user->group->id == 2)
            {
                $redirectUrl = $this->pageUrl($this->property('redirect_employer'))
                    ?: $this->property('redirect_employer');

                if ($redirectUrl = input('redirect_employer', $redirectUrl)) {
