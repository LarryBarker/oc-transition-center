...
class ResetPassword extends ComponentBase
{
    ...
    public function onRestorePassword()
    {
        ...
        Flash::success('Please check your email for a password reset link. Thank you.');
    }
    ...
    public function onResetPassword()
    {
        ...
        if (!$user->attemptResetPassword($code, post('password'))) {
            ...
            Flash::success('Your password has been successfully reset. Please login below using your email address and new password.');
        }
    }
