...
class Post extends Model
{
    ...
    public $rules = [
        ...
        'content' => 'required',
        'phone' => ['regex:/^\s*(?:\+?(\d{1,3}))?[-. (]*(\d{3})[-. )]*(\d{3})[-. ]*(\d{4})(?: *x(\d+))?\s*$/i'],
        'link' => ['active_url'],
        'excerpt' => ''
    ];
    ...
    public function scopeIsJobLead($query)
    {
            return $query
    ...
    /**
     * Lists archived posts for the front end
     * @param  array $options Display options
     * @return self
     */
    public function scopeListArchive($query, $options)
    {
        /*
         * Default options
         */
