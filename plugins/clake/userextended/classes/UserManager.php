...
{
    /**
     * Returns a all activated users who are currently job seeking, or
     * employed and approved for job seeking.
     * @param int $limit
     * @return Collection
     */
    public static function getActiveUsers(/*$limit = 5*/)
    {
        ...
        /*$userCount = User::whereHas('groups', function($q) {
            $q = where('id', '==', '4');
        })->count();*/
        $userCount = User::has('groups')->count();
